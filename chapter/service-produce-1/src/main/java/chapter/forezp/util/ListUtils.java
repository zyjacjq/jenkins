...
public class ListUtils {
    ...
    public static void main(String[] args) {
        ...
        list.add(new Student(123,"321","100"));
        list.add(new Student(123,"320","105"));
        list.add(new Student(124,"345","111"));
        list.add(new Student(124,"345","104"));
        list.add(new Student(125,"391","108"));
        System.out.println(list.toString());
        sort(list,new String[]{"id","name","sex"},new boolean[]{false,false,false});
        System.out.println(list.toString());
    }
}